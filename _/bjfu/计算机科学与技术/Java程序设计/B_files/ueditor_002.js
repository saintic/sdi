...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: URL + "jsp/controller.jsp?name="
        ...
        ,wordOverFlowMsg:'<span style="color:red;">您输入的内容长度已达临界值，请检查输入内容，尽量减少不必要的样式，内容超长可能无法保存考试结果！</span>'    //<span style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>
