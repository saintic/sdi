  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        .audiojs { width: 460px; height: 36px;margin-bottom:10px; background: #222d44; border-radius: 5px; overflow: hidden; font-family: monospace; font-size: 12px;opacity: 0.75; \
        ...
        .audiojs .scrubber { position: relative; float: left; width: 280px; background: #fff; height: 2px; margin: 17px 10px; } \
        .audiojs .audioAngle {cursor: pointer; position: absolute; width: 8px; height: 8px; border-radius:50%; background: #fff; left:0; top: -2px; z-index:99;} \
        .audiojs .progress { position: absolute; top: 0px; left: 0px; height: 2px; width: 0px; background: #3c91ff; z-index: 1;} \
        .audiojs .loaded { position: absolute; top: 0px; left: 0px; height: 2px; width: 0px; background: #bbc3cc;} \
        .audiojs .time {font-weight: normal; float: left; height: 36px; line-height: 36px; margin: 0px 0px 0px 6px; padding: 0px 6px 0px 12px;color: #f9f9f9; text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.5); } \
      ...
      updatePlayhead: function(percent) {
        ...
        this.wrapper.getElementsByClassName("audioAngle")[0].style.left = (progress.style.width); 
