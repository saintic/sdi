...
function ckplayerConfig() {
	return {
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			...
			// 	offsetY: 10
			// },
			// 为了在flash页面去掉logo，因此将offsetX变为-10000000000
			logo: {
				file: 'data:image/png;base64,',
				align: 'right',
				vAlign: 'top',
	...
	ckplayer.prototype = {
		...
		*/
		...
		// contextMenu: [
		// 	['ckplayer', 'link', 'https://www.ckplayer.com'],
		// 	['version:X', 'default'],
		...
		*/
		...
		interFace: function() {
			...
			*/
			...
			// 	cursor: 'default'
			// });
			// 为了即在h5又在flash去掉logo，因此只能修改样式，如果不考虑flash，只要将logo设为'null'即可
			this.css(logoID, {
				height: '0',
				lineHeight: '0',
				color: '#FFFFFF',
